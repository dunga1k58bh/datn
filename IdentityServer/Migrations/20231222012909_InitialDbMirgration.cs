...
{
    public partial class InitialDbMirgration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleClientGrants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleClientGrants_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RoleClientGrants_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleClientGrants_ClientId",
                table: "RoleClientGrants",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleClientGrants_RoleId",
                table: "RoleClientGrants",
                column: "RoleId");
        }
